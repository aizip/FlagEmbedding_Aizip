...
<p align="center">
    ...
    <a href="https://github.com/FlagOpen/FlagEmbedding_Aizip/tree/master/research/visual_bge">
...
## Usage
### Installation:
#### Install FlagEmbedding_Aizip:
```
git clone https://github.com/FlagOpen/FlagEmbedding_Aizip.git
cd FlagEmbedding_Aizip/research/visual_bge
pip install -e .
```
