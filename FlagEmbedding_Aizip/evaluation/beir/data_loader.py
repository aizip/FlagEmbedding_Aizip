...
class BEIREvalDataLoader(AbsEvalDataLoader):
    ...
    def available_dataset_names(self) -> List[str]:
        ...
        """
        return ['tesla_manual', 'sb_qna_split_b','sb_qna_split_a', 'sb_qna', 'tesla_manual', 'aizip_tesla', 'arguana', 'climate-fever', 'cqadupstack', 'dbpedia-entity', 'fever', 'fiqa', 'hotpotqa', 'msmarco', 'nfcorpus', 'nq', 'quora', 'scidocs', 'scifact', 'trec-covid', 'webis-touche2020']
