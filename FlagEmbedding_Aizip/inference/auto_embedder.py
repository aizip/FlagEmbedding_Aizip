...
from FlagEmbedding_Aizip.inference.embedder.model_mapping import (
    EmbedderModelClass,
        ...
        if model_class is not None:
            ...
            if model_name not in AUTO_EMBEDDER_MAPPING:
                raise ValueError(
                    ...
                    "`https://github.com/FlagOpen/FlagEmbedding_Aizip/tree/master/FlagEmbedding_Aizip/inference/embedder/model_mapping.py`. " 
                    "If need, you can create a new `<model>.py` file in `https://github.com/FlagOpen/FlagEmbedding_Aizip/tree/master/FlagEmbedding_Aizip/inference/embedder/encoder_only` "
                    "or `https://github.com/FlagOpen/FlagEmbedding_Aizip/tree/master/FlagEmbedding_Aizip/inference/embedder/decoder_only`. "
