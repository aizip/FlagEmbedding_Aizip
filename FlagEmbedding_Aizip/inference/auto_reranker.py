...
from FlagEmbedding_Aizip.inference.reranker.model_mapping import (
    RerankerModelClass,
        ...
        if model_class is not None:
            ...
            if model_name not in AUTO_RERANKER_MAPPING:
                raise ValueError(
                    ...
                    "`https://github.com/FlagOpen/FlagEmbedding_Aizip/tree/master/FlagEmbedding_Aizip/inference/reranker/model_mapping.py`. " 
                    "If need, you can create a new `<model>.py` file in `https://github.com/FlagOpen/FlagEmbedding_Aizip/tree/master/FlagEmbedding_Aizip/inference/reranker/encoder_only` "
                    "or `https://github.com/FlagOpen/FlagEmbedding_Aizip/tree/master/FlagEmbedding_Aizip/inference/reranker/decoder_only`. "
